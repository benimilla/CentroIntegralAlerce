...
class ActivityDetailBottomSheet: BottomSheetDialogFragment() {
    ...
    companion object {
        fun new(rol:String, nombre:String, lugar:String, hora:String): ActivityDetailBottomSheet {
            val b = ActivityDetailBottomSheet()
            b.arguments = Bundle().apply { putString("rol",rol); putString("nombre",nombre); putString("lugar",lugar); putString("hora",hora) }
            return b
        }
    }
}
